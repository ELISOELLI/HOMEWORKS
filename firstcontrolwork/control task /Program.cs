// Итоговая проверочная работа в главе выбор специализации -задача //
...
Console.WriteLine(); // так, для аккуратности и читабельности в консоли (терминале)
count = 0; // не забываем обнулить счетчик
for (int i = 0; i < arrayOfStrings.GetLength(0); i++)
{
    if (compareStringsForOurTask(arrayOfStrings[i])) // сверим с условием задачи
    {
